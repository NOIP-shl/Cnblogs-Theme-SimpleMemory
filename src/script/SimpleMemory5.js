...
if(initCheck()) {
	...
	window.cnblogsConfigDefault = {
		...
		GhVersions: 'v1.1.4',
		blogUser: "AD_shl.",
		blogAvatar: "https://www.cnblogs.com/images/cnblogs_com/shl-blog/1415531/t_1561259377411.jpg",
		blogStartDate: "2019-03-09",
		menuCustomList: {},
		menuNavList: [],
		...
		homeBannerTextType: "",
		essayTopImg: [
			"https://raw.githubusercontent.com/NOIP-shl/Cnblogs-Theme-SimpleMemory/master/img/mountain-1149897__340.jpg"
		],
		...
		bottomBlogroll: [
			["申请坑位", 'https://msg.cnblogs.com/send/shl-blog'],
    			["申请坑位", 'https://msg.cnblogs.com/send/shl-blog'],
   			["申请坑位", 'https://msg.cnblogs.com/send/shl-blog'],
     			["申请坑位", 'https://msg.cnblogs.com/send/shl-blog'],
     			["申请坑位", 'https://msg.cnblogs.com/send/shl-blog'],
	...
	var navListHtml = '<li><a href="https://www.cnblogs.com/' + user + '/" target="_self">首页</a></li>' +
		...
		'<li><a href="https://i.cnblogs.com/" target="_blank">管理</a></li>' +
	   	'<li><a href="https://github.com/NOIP-shl" target="_blank">GitHub</a></li>' +
	    	'<li><a href="https://www.cnblogs.com/shl-blog/p/11380118.html" target="_blank">友链</a></li>';
